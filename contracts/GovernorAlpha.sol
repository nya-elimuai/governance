...
contract GovernorAlpha {
    ...
    function votingDelay() public pure returns (uint) { return 1; } // 13140 blocks, ~2 days

    /// @notice The duration of voting on a proposal, in blocks
    function votingPeriod() public pure returns (uint) { return 270; } // ~7 days in blocks (assuming 15s blocks)
